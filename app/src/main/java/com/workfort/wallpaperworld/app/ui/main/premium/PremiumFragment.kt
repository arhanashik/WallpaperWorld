package com.workfort.wallpaperworld.app.ui.main.premium
...
class PremiumFragment : Fragment() {
    ...
    private fun loadWallpapers() {
        ...
        parent.disposable.add(parent.apiService.getWallpapers(
            Const.WallpaperType.PREMIUM, page)
    ...
    fun openImageViewer(wallpaper: WallpaperEntity) {
        ...
        intent.putExtra(Const.Key.WALLPAPER_TYPE, Const.WallpaperType.PREMIUM)
